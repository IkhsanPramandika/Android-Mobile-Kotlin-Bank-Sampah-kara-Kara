...
import com.example.uas_mobile.databinding.ActivityLoginUserBinding
...
class ActivityLoginUser : AppCompatActivity() {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (userSnapshot in dataSnapshot.children) {
                        ...
                        if (password == storedPassword) {
                            ...
                            val intent = Intent(this@ActivityLoginUser, MainActivity::class.java)
                            startActivity(intent)
                            finish()
                        } else {
                            // Password tidak sesuai, handle kesalahan login
                            Toast.makeText(
                                this@ActivityLoginUser,
                                "Password salah",
                                Toast.LENGTH_SHORT
                            )
                                .show()
    ...
    fun panggilActivityRegister(view: View?) {
        val i = Intent(applicationContext, ActivityRegister::class.java)
        startActivity(i)
    }
